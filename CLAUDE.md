...
а живых предупреждений в дереве 86 (все по `jsx-a11y` в админке), поэтому код возврата нулевой
и при новом. Смотреть глазами вывод линта по своим файлам, а не только его код. Требование
переехало сюда 07.09.2026 из `AGENTS.md` (`LEGACY-168`), где было единственной копией.
