...
describe('localProgress', () => {
   ...
   *
   * ⚠️ Этот тест фиксирует **текущее** поведение, а не желаемое. Наивный страж
   * «дальняя глава не откатывается ближней» пробовался 06.09.2026 и снят
   * решением арбитра: он запрещает и законный возврат читателя к ранней главе,
   * то есть чинит редкий сценарий двух вкладок ценой частого. Разбор — в теле
   * `LEGACY-269`, запись открыта.
   */
