...
const ROLE_OPTIONS: { label: string; value: ContributorRole }[] = [
  ...
  { label: 'Фотограф (Photographer)', value: 'PHOTOGRAPHER' },
  { label: 'Автор предисловия (Introduction Author)', value: 'INTRODUCTION_AUTHOR' },
  { label: 'Автор комментариев (Annotation Author)', value: 'ANNOTATION_AUTHOR' },
  { label: 'Составитель (Compiler)', value: 'COMPILER' },
  { label: 'Адаптер (Adapter)', value: 'ADAPTER' },
  { label: 'Дизайнер обложки (Cover Designer)', value: 'COVER_DESIGNER' },
  { label: 'Картограф (Cartographer)', value: 'CARTOGRAPHER' },
