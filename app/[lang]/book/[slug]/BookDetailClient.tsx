...
// Dynamically load non-critical sections (reviews and extra details) to exclude their CSS from the main render-blocking bundle
  ...
  return (
    <div className={styles.bookPage}>
      <div className={styles.container}>
        ...
        {/* Dynamically loaded extra details (FAQ, symbols, quotes, characters) to isolate non-critical CSS */}
        {isMounted && activeVersion && (
